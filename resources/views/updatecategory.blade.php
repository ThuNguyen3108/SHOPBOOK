                        ...
                        <div class="table-responsive">
                            ...
                            @csrf
                                <table id="addproduct" width="100%">
                                    ...
                                    <tbody>
                                        <td><input required name="tentheloai" id="tensp" type="text" value="{{$namecategory->name}}" placeholder="không rỗng"></td>
                                        <td><button id="btnAdd" type="submit" onclick="addItem()">Cập Nhật</button></td>
                                    </tbody>
                                </table>
                                @if (session('status'))
