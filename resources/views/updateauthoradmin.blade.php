                            ...
                            <div class="table-responsive">
                                ...
                                @csrf
                                    <table id="addproduct" width="100%">
                                        ...
                                        <tbody>
                                            <td><input required name="tentacgia" id="tensp" type="text" value="{{$idauthor->name}}" placeholder="không rỗng"></td>
                                            <td><button id="btnAdd" type="submit" onclick="addItem()">Chỉnh sửa</button></td>
                                        </tbody>
                                    </table>
                                    @if (session('status'))
